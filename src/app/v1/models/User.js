...
const user = {
  ...
  createPlayList: function ({ userId, title, encodeId }, callback) {
    return connection.query(
      `INSERT INTO user_playlist (userId, encodeId, title) value('${userId}', '${encodeId}', '${title}')`,
      callback
    );
  },

  updatePlayList: function ({ userId, encodeId, ...body }, callback) {
